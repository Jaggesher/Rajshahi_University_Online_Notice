...
<head>
	...
	<link rel="stylesheet" type="text/css" href="mycss/oficialUpload.css"/>
	<script src="myjs/official.js"></script>
</head>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#myPage" style="font-size:25px;">Notice Board|Uploader</a>
			</div>
